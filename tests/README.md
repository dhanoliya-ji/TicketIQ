...
**220 tests, 98% coverage of `app/`.** Every test is offline and deterministic:
...
| `test_agent.py` | mock tools, JSON extraction from prose, the ReAct loop, malformed replies, repeated tool calls, the step limit | 27 |
